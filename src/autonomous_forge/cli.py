...
def build_parser() -> argparse.ArgumentParser:
    ...
    for command, help_text, format_help in (
        ...
        ("executor-gate", "preview guarded executor preconditions without running commands", "executor gate format: text (default) or JSON"),
        ("executor-contract", "preview the future validation executor contract without running commands", "executor contract format: text (default) or JSON"),
...
_POLICY_AWARE_READERS = {
    ...
    "executor-gate": read_executor_precondition_gate,
    "executor-contract": read_executor_contract,
