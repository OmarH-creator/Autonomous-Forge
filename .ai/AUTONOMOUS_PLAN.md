...
Scope: Add a read-only executor contract preview that consumes executor-gate data and describes required CLI flags, allowed command classes, refusal cases, result capture shape, timeout policy, and non-goals.
Expected files or areas: `src/autonomous_forge/`, `tests/`, README, `docs/`, `.ai` records.
...
Notes: This should precede any implementation of a command runner.
