...
Notes: The next safe step is adding CI smoke coverage for patch-application audit, then designing only read-only application gates until a concrete write-capable patch applier can be proven safe.
