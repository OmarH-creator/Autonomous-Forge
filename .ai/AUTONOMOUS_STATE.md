...
- Validation: AUTO-229 deterministic coverage disables `Path.read_bytes()` and hashes multi-megabyte evidence exactly through the streaming helper. README/status head `1869c56cdcb75031b551fc039bfc18fc5c7a57b8` passed Actions run `33259355704`; Python 3.10, 3.11, and 3.12 all passed installation, source compilation, installed CLI smoke tests, roadmap validation, and pytest.
