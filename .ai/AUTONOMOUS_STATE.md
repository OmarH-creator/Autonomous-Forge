...
- Current branch: main
- Last run timestamp: 2026-08-31T07:11:00Z
...
- Validation: Deterministic regression tests were added for clean rollback after first publication-directory sync failure and for preserving a destination changed before ownership-checked rollback. Final GitHub Actions validation on the completed head is pending; completion must not be reported until Python 3.10, 3.11, and 3.12 pass package installation, source compilation, installed CLI smoke tests, roadmap validation, and pytest.
